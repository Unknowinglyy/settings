  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(ev)
        ...
        -- opts.desc = "Show signature while in insert mode"
    ...
    --
    -- Setup servers
    -- not needed anymore with blink... hopefully...
    ...
    vim.lsp.config("rust_analyzer", {
      settings = {
        ["rust-analyzer"] = {
          ...
          -- maybe overides the 4 space tab from rustfmt?
          -- rustfmt = {
          --   overrideCommand = {"rustfmt", "--config", "tab_spaces=2" },
          -- },
          checkOnSave = {
            command = "clippy",
          },
          -- disable function argument snippets being added on accepted completions
          completion = {
            callable = {
